...
import 'package:scmarketplace/vendor/views/screens/vendorProductDetail/vendor_product_detail_screen.dart';
    ...
    return Scaffold(
      ...
      builder: (BuildContext context, AsyncSnapshot<QuerySnapshot> snapshot) {
        ...
        if(snapshot.data!.docs.isEmpty){
          return Center(
            child: Text('No Published Product',
            style: TextStyle(
              fontSize: 25,
                  ...
                  child: Row(
                    children: [
                      ...
                      Column(
                        ...
                        children: [
                          Text(vendorProductData['productName'],style: TextStyle(
                            fontSize: 17,
                            fontWeight: FontWeight.bold),
                            ),
