              ...
              child: Form(
                ...
                child: Column(children: [
                  TextFormField(
                    ...
                    validator: (value){
                      if(value!.isEmpty){
                        return 'Please Insert Your Business Name';
                      }else{
                        return null;
                      }
                    },
                  ...
                  Padding(
                    ...
                    child: TextFormField(
                      ...
                      validator: (value){
                      if(value!.isEmpty){
                        return 'Please Insert Your Tax Number';
                      }else{
                        return null;
                      }
                    },
                  ...
                  InkWell(
                    ...
                    child: Center(child: Text('Save', style:TextStyle(fontSize: 18,color: Colors.white,fontWeight: FontWeight.bold),),),
                    ),
                  )
                ],),
              ), 
