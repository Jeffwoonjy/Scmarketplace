      ...
      child: Column(
        children: [
                  ...
                  return Padding(
                    ...
                    child: InkWell(
                      ...
                      child: Container(
                        ...
                        child: Padding(
                          padding: const EdgeInsets.all(8.0),
                          child: Text(_sizeList[index],style: TextStyle(color: Colors.white,fontWeight: FontWeight.bold),
                          ),
                        ),
                      ),
                    ),
          ...
          ElevatedButton(onPressed: (){
            ...
            _isSave ? 'Saved':'Save',style: TextStyle(fontWeight: FontWeight.bold,letterSpacing: 3,),),),
        ],
      ),
    );
  }
