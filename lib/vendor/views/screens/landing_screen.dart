...
import 'package:scmarketplace/vendor/models/vendor_users_menu.dart';
        ...
        return Center(child: Column(
          ...
          children: [
            ClipRRect(
              ...
              child:Image.network(vendorUserModel.storeImage.toString(),width: 90, fit: BoxFit.cover,),
            ),
            ...
            SizedBox(height: 10,),
            Text(
              'Your application have been sent to shop admin\n Admin will get back to you soon!', 
